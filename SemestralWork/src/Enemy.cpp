...
Enemy::Enemy() : mSpeed(3), mBombPosition(), mExplosion(false), mBombReady(true), mBombTickingTime(3), mNow(SDL_GetTicks()),
                 mTimer(SDL_GetTicks()), mBombTickingTimer(SDL_GetTicks()), mMoving(false)
{}
